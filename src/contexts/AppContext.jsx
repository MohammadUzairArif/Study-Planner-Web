...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "TOGGLE_COMPLETE": return { ...state, tasks: state.tasks.map(t => t.id === action.payload ? {...t, completed: !t.completed } : t) };
...
export const AppProvider = ({ children }) => {
  ...
  return (
    <AppContext.Provider value={{
      ...
      addNote, updateNote, addPomodoro, addAchievement, setStats
    }}>
      {children}
    </AppContext.Provider>
  );
